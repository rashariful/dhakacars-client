...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to dhakacars, house 03, road 03, Nikunja 02..
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to dhakacars, accessible from{" "}
            <a
              href="https://www.dhakacars.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.dhakacars.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: https://www.dhakacars.com/</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://www.dhakacars.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.dhakacars.com/contact
            </a>
          </p>
        </li>
      </ul>
